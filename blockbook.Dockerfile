...
RUN wget https://raw.githubusercontent.com/cpuchain/cpuchain/master/cpuchain.pgp && \
  ...
  aria2c -x 5 https://github.com/cpuchain/blockbook/releases/download/${BLOCKBOOK_VERSION}/backend-cpuchain-testnet_${VERSION}-satoshilabs-1_amd64.deb && \
  ...
  aria2c -x 5 https://github.com/cpuchain/blockbook/releases/download/${BLOCKBOOK_VERSION}/blockbook-cpuchain-testnet_${BLOCKBOOK_VERSION}_amd64.deb && \
